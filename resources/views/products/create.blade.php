                    ...
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <textarea class="form-control @error('descripcion_larga') is-invalid @enderror" 
                                          ...
                                          placeholder="Descripción detallada del producto">{{ old('descripcion_larga') }}</textarea>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('precio_neto') is-invalid @enderror" 
                                           id="precio_neto" name="precio_neto" value="{{ old('precio_neto') }}" 
                                           min="0" step="0.01" placeholder="0.00" required>
                                </div>
                                @error('precio_neto')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">El precio con IVA se calculará automáticamente</div>
                            </div>
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="number" class="form-control @error('stock_actual') is-invalid @enderror" 
                                       id="stock_actual" name="stock_actual" value="{{ old('stock_actual') }}" 
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="number" class="form-control @error('stock_minimo') is-invalid @enderror" 
                                       id="stock_minimo" name="stock_minimo" value="{{ old('stock_minimo') }}" 
                                       min="0" placeholder="0" required>
                                @error('stock_minimo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="number" class="form-control @error('stock_bajo') is-invalid @enderror" 
                                       id="stock_bajo" name="stock_bajo" value="{{ old('stock_bajo') }}" 
                                       min="0" placeholder="0" required>
                                @error('stock_bajo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="number" class="form-control @error('stock_alto') is-invalid @enderror" 
                                       id="stock_alto" name="stock_alto" value="{{ old('stock_alto') }}" 
                                       min="0" placeholder="0" required>
                                @error('stock_alto')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="ti ti-check me-2"></i>Crear Producto
                            </button>
                        </div>
                    </form>
                </div>
